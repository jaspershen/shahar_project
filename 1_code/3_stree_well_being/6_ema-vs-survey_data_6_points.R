...
dir.create(
  "3_data_analysis/3_stress_and_well_being/ema-vs-survey_data_6_points",
  recursive = TRUE
)
setwd("3_data_analysis/3_stress_and_well_being/ema-vs-survey_data_6_points")
...
plot <-
  temp %>%
  plyr::dlply(.variables = .(time_point)) %>%
  purrr::map(function(x) {
    x %>%
...
plot
ggsave(plot,
       filename = "Stress_PSS-Energy_total.pdf",
       width = 7,
       height = 7)

ggsave(plot,
       filename = "Stress_PSS-Energy_total.png",
       width = 7,
       height = 7)
...
plot
ggsave(plot,
       filename = "Stress_PSS-Mood-total.pdf",
       width = 7,
       height = 7)
ggsave(plot,
       filename = "Stress_PSS-Mood-total.png",
       width = 7,
       height = 7)
...
plot
ggsave(plot,
       filename = "Stress_PSS-Focus-total.pdf",
       width = 7,
       height = 7)
ggsave(plot,
       filename = "Stress_PSS-Focus-total.png",
       width = 7,
       height = 7)


###Stress_PSS vs Connectedness
plot <-
  temp %>%
...
plot
ggsave(plot,
       filename = "Stress_PSS-Connectedness-total.pdf",
       width = 7,
       height = 7)
ggsave(plot,
       filename = "Stress_PSS-Connectedness-total.png",
       width = 7,
       height = 7)

####tress_PSS vs Clarity
plot <-
  temp %>%
...
plot
ggsave(plot,
       filename = "Stress_PSS-Clarity-total.pdf",
       width = 7,
       height = 7)

ggsave(plot,
       filename = "Stress_PSS-Clarity-total.png",
       width = 7,
       height = 7)
