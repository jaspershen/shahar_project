...
dir.create("3_data_analysis/1_data_preparation/survey_data")
setwd("3_data_analysis/1_data_preparation/survey_data")
...
# pfi <-
#   pfi %>%
#   dplyr::mutate(pfi_fulfillment = pfi_fulfillment,
...
# perma <-
#   perma %>%
#   dplyr::mutate(perma_pos_emotions = perma_pos_emotions,
...
#   olbi[, c("olbi_1", "olbi_3_r", "olbi_6_r", "olbi_7", "olbi_9_r", "olbi_11_r", "olbi_13", "olbi_15")] %>%
#   apply(1, function(x){
#     sum(x, na.rm = TRUE)
#   })
#
# burnout_exhaustion <-
#   olbi[, c("olbi_2_r", "olbi_4_r", "olbi_5", "olbi_8_r", "olbi_10", "olbi_12_r", "olbi_14", "olbi_16")] %>%
#   apply(1, function(x){
#     sum(x, na.rm = TRUE)
#   })
#
# olbi <-
# olbi %>%
#   dplyr::mutate(burnout_total = burnout_total,
#                 burnout_disengagement = burnout_disengagement,
#                 burnout_exhaustion = burnout_exhaustion) %>%
#   dplyr::select(subject_id, check_point, sample_id,
#                 burnout_total,
#                 burnout_disengagement,
#                 burnout_exhaustion,
#                 everything())
...
#   dplyr::select(subject_id, check_point,
#                 sample_id,
#                 self_efficacy_total,
#                 everything())
#
...
#
# dom1 <-
#   who[,c("who_3_r", "who_4_r", "who_10", "who_15", "who_16", "who_17", "who_18")] %>%
#   apply(1, function(x){
#     mean(x, na.rm = TRUE) * 4
#   })
#
...
#
# dom4 <-
#   who[,c("who_8", "who_9", "who_12", "who_13", "who_14", "who_23", "who_24", "who_25")] %>%
#   apply(1, function(x){
#     mean(x, na.rm = TRUE) * 4
#   })
#
...
#   dplyr::select(subject_id, check_point, sample_id, gratitude_total,
#                 everything())
#
...
sample_info <-
  ...
  purrr::map(function(x) {
    ...
    data.frame(
      ...
      sample_id = paste(x$record_id[1], 1:5, sep = "_"),
      survey_timestamp = c(time1, time2, time3, time4, time5),
      check_point = as.character(1:5)
    ) %>%
