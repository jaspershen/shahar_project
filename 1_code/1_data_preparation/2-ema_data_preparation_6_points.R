...
ema_data <-
  readr::read_csv("2_data/66491TheLastingChang-EMADWDAndPost_DATA_2024-04-07_1538 (1).csv")

dir.create("3_data_analysis/1_data_preparation/ema_data_6_points")
setwd("3_data_analysis/1_data_preparation/ema_data_6_points")
...
variable_info1 <- variable_info


load("../ema_data/expression_data")
load("../ema_data/sample_info")
load("../ema_data/variable_info")
